...
public final class EnvUtil {
    ...
    public static Map<String, Object> createEnvironment(boolean securityEnabled) {
        ...
        // i.e. to connect to the Internet. SOAP connections to WebSphere should not pass through
        // that proxy.
        ...
        WebSphereClassLoaderProvider classLoaderProvider =
                WebSphereClassLoaderProvider.getInstance();
