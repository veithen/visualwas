...
public class ApplicationManagerFeature implements Feature {
    private static final Interface<ApplicationManager> APPLICATION_MANAGER_INTERFACE =
            InterfaceFactory.createInterface(ApplicationManager.class);
    ...
    public void configureConnector(Configurator configurator) {
        try {
            configurator
                    ...
                    .registerProxy(
                            APPLICATION_MANAGER_INTERFACE,
                            new ObjectNamePatternMBeanLocator(
