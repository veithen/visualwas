...
/**
 * Replacement class for WebSphere's <code>WsLevel</code> class. It prevents the WebSphere code from
 * registering is own log levels, because this would cause a class loader leak (see <a
 * href="http://bugs.sun.com/view_bug.do?bug_id=6543126">JDK-6543126</a>).
 */
