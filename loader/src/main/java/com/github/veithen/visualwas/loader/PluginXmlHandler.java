...
final class PluginXmlHandler extends DefaultHandler {
    private enum State { DOCUMENT, PLUGIN, EXTENSION, SERIALIZABLE }
        ...
        if (skipDepth > 0) {
            ...
            switch (state) {
                case DOCUMENT:
                    ...
                    break;
                case PLUGIN:
                    if (localName.equals("extension") && "com.ibm.wsspi.extension.serializable".equals(attributes.getValue("", "point"))) {
