...
public class ConfigClientFeature implements Feature {
    private static final Interface<ConfigService> CONFIG_SERVICE_INTERFACE =
            InterfaceFactory.createInterface(ConfigService.class);
    ...
    public void configureConnector(Configurator configurator) {
        configurator
                ...
                .addMappedClasses(ConfigDataId.class);
        configurator
                .getAdapter(MBeanProxyConfigurator.class)
                .registerProxy(
                        CONFIG_SERVICE_INTERFACE, new SingletonMBeanLocator("ConfigService"));
    }
}
