...
public final class RasLoggingFeature implements Feature {
    public static final Feature INSTANCE = new RasLoggingFeature();

    private RasLoggingFeature() {}

    @Override
    public void configureConnector(Configurator configurator) {
        configurator.getAdapter(ClassMappingConfigurator.class).addMappedClasses(RasMessage.class);
    }
}
