...
public final class RepositoryClientFeature implements Feature {
    private static final Interface<ConfigRepository> CONFIG_REPOSITORY_INTERFACE =
            InterfaceFactory.createInterface(ConfigRepository.class);
    ...
    public void configureConnector(Configurator configurator) {
        ...
        configurator
                ...
                .registerProxy(
                        CONFIG_REPOSITORY_INTERFACE, new SingletonMBeanLocator("ConfigRepository"));
    }
}
