...
public class RasLoggingITCase extends WebSphereITCase {
    ...
    protected Feature[] getFeatures() {
        return new Feature[] {
                ...
                NotificationDispatcherFeature.INSTANCE };
    }

    @Test
    public void test() throws Exception {
        ObjectName rasLoggingService = connector.queryNames(new ObjectName("WebSphere:type=RasLoggingService,*"), null).iterator().next();
        ObjectName applicationManager = connector.queryNames(new ObjectName("WebSphere:type=ApplicationManager,*"), null).iterator().next();
        ...
        connector.invokeAsync(applicationManager, "stopApplication", new Object[] { "query" }, new String[] { String.class.getName() });
        while (true) {
        ...
        connector.invoke(applicationManager, "startApplication", new Object[] { "query" }, new String[] { String.class.getName() });
