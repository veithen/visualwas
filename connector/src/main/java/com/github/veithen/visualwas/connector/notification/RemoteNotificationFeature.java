...
public final class RemoteNotificationFeature implements Feature {
    private static final Interface<RemoteNotificationService>
            REMOTE_NOTIFICATION_SERVICE_INTERFACE =
                    InterfaceFactory.createInterface(RemoteNotificationService.class);
