...
public final class ObjectHandler implements TypeHandler {
    ...
    public QName getXMLType(InvocationContextImpl context) {
        return new QName(
                ...
                context.getSerializer().getRemoteClassName(type),
                "soap");
    }
    ...
    @Override
    public Object extractValue(OMElement element, InvocationContextImpl context)
        ...
        try {
            ...
            throw new TypeHandlerException(
                    "Failed to deserialize object (expected type: " + type.getName() + ")", ex);
        }
    }
}
