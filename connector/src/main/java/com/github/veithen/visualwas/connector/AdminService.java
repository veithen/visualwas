...
public interface AdminService {
    ...
    CompletableFuture<Set<ObjectInstance>> queryMBeansAsync(
     ...
     * @param operationName the the name of the operation to be invoked
     ...
     * @throws InstanceNotFoundException if no MBean with the given object name is registered in the
     *     MBean server
     * @throws MBeanException if the method on the MBean throws an exception (in which case the
     *     {@link MBeanException} wraps that exception)
     * @throws ReflectionException if a problem occurs while trying to invoke the method through
     *     reflection
     * @throws IOException if a communication problem occurred
     * @throws ClassNotFoundException if the result (return value or exception thrown by the
     *     operation) could not be deserialized because the class loader provided by the {@link
     *     ClassLoaderProvider} was unable to load a required class
     */
    Object invoke(
            @Param(name = "objectname") ObjectName objectName,
     ...
     * @throws MBeanException if the MBean's getter method throws an exception (in which case the
     *     {@link MBeanException} wraps that exception)
     * @throws AttributeNotFoundException if the attribute specified is not accessible in the MBean
     * @throws InstanceNotFoundException if no MBean with the given object name is registered in the
     *     MBean server
     * @throws ReflectionException if a problem occurs while trying to invoke the getter method
     *     through reflection
     * @throws IOException if a communication problem occurred
     * @throws ClassNotFoundException if the attribute value (or the exception thrown by the getter
     *     method) could not be deserialized because the class loader provided by the {@link
     *     ClassLoaderProvider} was unable to load a required class
     */
    Object getAttribute(
            @Param(name = "objectname") ObjectName objectName,
     ...
     *
     * @param objectName the object name of the MBean from which the attributes are retrieved
     * @param attributes a list of the attributes to be retrieved
     * @return the list of the retrieved attributes
     * @throws InstanceNotFoundException if no MBean with the given object name is registered in the
     *     MBean server
     * @throws ReflectionException if an exception occurred when trying to invoke the getAttributes
     *     method of a Dynamic MBean
     * @throws IOException if a communication problem occurred
     * @throws ClassNotFoundException if some attribute value could not be deserialized because the
     *     class loader provided by the {@link ClassLoaderProvider} was unable to load a required
     *     class
     */
    ...
    CompletableFuture<AttributeList> setAttributesAsync(
