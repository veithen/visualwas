...
public final class DependencyUtil {
    ...
    public static void process(
            Feature feature,
            Collection<Feature> unprocessedFeatures,
            Collection<Feature> processedFeatures) {
    ...
    public static void resolveDependencies(
            ...
            Collection<Feature> processedFeatures) {
        deploop:
        for (Class<? extends Feature> dependencyClass : ann.value()) {
            ...
            if (dependency == null) {
                ...
                throw new RuntimeException(
                        "Unsatisfied dependency of type " + dependencyClass.getName());
            }
