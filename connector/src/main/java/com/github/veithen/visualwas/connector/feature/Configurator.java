 ...
 * this instance are only valid during the invocation of {@link
...
public interface Configurator extends Adaptable {
     ...
     * @throws IllegalStateException if the serializer has already been set by another feature
     */
     ...
     * corresponding adapter instance can be retrieved by invoking {@link
     * Adaptable#getAdapter(Class)} on the {@link Connector} instance. The {@link AdminService}
     * instance passed to {@link AdapterFactory#createAdapter(AdminService, Executor)} will also
