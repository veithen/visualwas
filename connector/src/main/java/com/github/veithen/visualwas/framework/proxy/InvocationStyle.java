...
public abstract class InvocationStyle {
    public static final InvocationStyle SYNC =
            new InvocationStyle() {
                @Override
                ...
                @Override
                Object invoke(InvocationTarget target, Operation operation, Object[] args)
                        throws Throwable {
                    try {
    ...
    public static final InvocationStyle ASYNC =
            new InvocationStyle() {
                @Override
                MethodInfo getMethodInfo(Method method) {
                    if (method.getReturnType() == CompletableFuture.class
    ...
    abstract Object invoke(InvocationTarget target, Operation operation, Object[] args)
            throws Throwable;
}
