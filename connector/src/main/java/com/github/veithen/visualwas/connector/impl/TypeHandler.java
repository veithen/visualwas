...
public interface TypeHandler {
     ...
     * @return the value
     * @throws ClassNotFoundException if a required class could not be loaded by the class loader
     *     returned by {@link InvocationContextImpl#getClassLoader()}
     * @throws TypeHandlerException if another error occurred
     */
    Object extractValue(OMElement element, InvocationContextImpl context)
            throws ClassNotFoundException, TypeHandlerException;
}
