...
public class ContextPopulatingInterceptorTest {
    ...
    /**
     * Tests that a failure to retrieve the context value results in a meaningful exception (instead
     * of {@link UndeclaredThrowableException}).
     *
     * @throws Exception
     */
                                ...
                                new Feature() {
                                    ...
                                    public void configureConnector(Configurator configurator) {
                                        configurator.addInvocationInterceptor(
                                                new ContextPopulatingInterceptor<DummyContextKey>(
                                                        DummyContextKey.class) {
                                                    @Override
                                                    protected CompletableFuture<DummyContextKey>
                                                            produceValue(
                                                                    AdminService adminService) {
                                                        CompletableFuture<DummyContextKey> future =
